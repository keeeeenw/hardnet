# This is a copy of https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
# modified to support only 1 color channel input.
import torch
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2,
                                       dilate=replace_stride_with_dilation[1], dropout=dropout)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, dropout=0.0):
        ...
        if dropout > 0.0:
            print("Confimring dropout layer with p", dropout)
...
class ResNetHard(nn.Module):
    def __init__(self, block, layers, num_classes=128, zero_init_residual=False,
        ...
        self.layer4 = self._make_layer(block, 128, layers[3], stride=2,
                                       dilate=replace_stride_with_dilation[0], dropout=dropout)
...
def reshardnet(dropout=0.0):
    return ResNetHard(BasicBlock, [3, 4, 6, 6, 3], dropout=dropout)
