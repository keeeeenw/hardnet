...
python ./code/HardNet.py --w1bsroot "$DATASETS/wxbs-descriptors-benchmark/code/" --fliprot=True --experiment-name=densenet_tiny_liberty_train_with_aug_test/ --model-variant=densenet_tiny --epochs=10 --n-triplets=5000 --enable-logging=False